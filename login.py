...
def forget_pass():
    def change_password():
        if user_entry.get()=='' or newpass_entry.get()=='' or confirmpass_entry.get()=='':
            ...
            con = pymysql.connect(host='localhost', user='root', password='T#9758@qlph', database='userdata')
            mycursor = con.cursor()
...
forgetButton.place(x=715, y=290)
...
newaccountButton=Button(login_window, text='Create Account', font=('Open Sans', 9, 'bold underline'), fg='blue',
